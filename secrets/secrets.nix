let
  ...
  cpritchett = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEApFR9UNrE2s+i/G/VPncNcR6y0bXzIpsNR2JlcASA9";
  ...
  all = [ agenix cpritchett ];
  users = [ cpritchett ];
  systems = [ flotilla test-macos test-nixos ];
